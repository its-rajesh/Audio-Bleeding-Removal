...
from iwaveunnet_ge import GraphCNN

# Load the model with custom objects
custom_objects = {"GraphCNN": GraphCNN}

path = "/home/anchal/Desktop/rajesh/UNet/iWaveUNet/ChebGCN/"
#model = tf.keras.models.load_model(path+'iwaveunet_ge.h5', compile=False)
model = load_model(path + 'iwaveunet_ge.h5', custom_objects=custom_objects, compile=False)
