...
# test Audio path
bpath = "/home/anchal/Desktop/rajesh/Datasets/musdb18hq_bleeded/test/Mu - Too Bright/"
tpath = "/home/anchal/Desktop/rajesh/Datasets/musdb18hq/test/Mu - Too Bright/"

print("Loading Model")
di3_dca = keras.models.load_model("/home/anchal/Desktop/rajesh/DI_Bleed_Archs/Separate/bass_model.h5")

print("Loading Files")
xtest, fs = lb.load(bpath+'bass.wav')
ytest, fs = lb.load(tpath+'bass.wav')
