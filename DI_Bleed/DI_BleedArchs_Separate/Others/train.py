...
path = "/home/anchal/Desktop/rajesh/DI_Bleed_Archs/Separate/Others/"

print("Loading Dataset")
xtrain = np.load(path+'xtrain_other.npy')
xtest = np.load(path+'xtest_other.npy')
ytrain = np.load(path+'ytrain_other.npy')
ytest = np.load(path+'ytest_other.npy')
