...
path = "/home/anchal/Desktop/rajesh/DI_Bleed_Archs/Separate/Drums/"

print("Loading Dataset")
xtrain = np.load(path+'xtrain_drums.npy')
xtest = np.load(path+'xtest_drums.npy')
ytrain = np.load(path+'ytrain_drums.npy')
ytest = np.load(path+'ytest_drums.npy')
