...
def iter1(di3_dca, bpath, tpath, out_path):
    ...
    xtest, fs = lb.load(bpath+'/drums.wav')
    ytest, fs = lb.load(tpath+'/drums.wav')
...
print("Loading Model")
di3_dca = keras.models.load_model("/home/anchal/Desktop/rajesh/DI_Bleed_Archs/Separate/Drums/drums_model.h5")
